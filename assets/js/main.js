(function ($) {
	...
	/*=============================================
		=       Mouse Follower      =
	=============================================*/
		const disableCustomCursor = true;
		const mouseFollowerRoot = document.querySelector(".mouse-follower");
		if (disableCustomCursor) {
			if (mouseFollowerRoot) {
				mouseFollowerRoot.style.display = "none";
				mouseFollowerRoot.style.visibility = "hidden";
			}
		} else {
			...
			$(terElement).on("mouseenter", function () {
				$(".mouse-follower").addClass("hide-cursor");
			});
			$(terElement).on("mouseleave", function () {
