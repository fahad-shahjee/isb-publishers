...
<body>
    ...
    <!-- header-area -->
    <header>
        <div id="header-sticky" class="td-header__area td-header-sticky-white td-header-spacing td-header-2-wrapper p-relative z-index-1">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-2 col-4">
                        <div class="logo">
                            <a class="logo-1" href="index.html"><img data-width="96" src="assets/img/logo/logo-yellow.png" alt="Logo"></a>
                                    ...
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="index.html">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="index-2.html">Startup Agency</a></li>
                    ...
                    <div class="col-xl-3 col-8">
                        <div class="td-header-right td-header-2-right text-end">
                            <div class="d-none d-md-inline-block">
                             ...
                             <div class="d-inline-block">
                                 <div class="tdmenu-offcanvas-open-btn ml-20 d-xl-none mobile-nav-toggler d-flex align-items-center justify-content-center">
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <main>
                <!-- td-hero-area-start -->
                <div class="td-hero-area td-btn-trigger td-hero-2-spacing p-relative fix z-index-1 include-bg" data-background="assets/img/hero/hero-2/bg.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="td-hero-2-title-wrap">
                                    <h2 class="td-hero-2-title mb-100">
                                        <span class="d-flex align-items-center td-split-text td-split-in-right">CREATIVE <i class="fa-sharp fa-solid fa-arrow-right"></i></span>
                                        <span class="td-split-text td-split-in-right">STRATEGIES TO</span>
                                        <span class="td-split-text td-split-in-right">GET GROWING</span>
                                    </h2>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="td-hero-2-thumb p-relative z-index-1">
                                    <div class="td-btn-bounce">
                                        <img class="thumb-3" src="assets/img/hero/hero-2/shape-1.png" alt="">
                                    </div>
                                    <img class="thumb-4 td-btn-bounce" src="assets/img/hero/hero-2/shape-2.png" alt="">
                                    <img class="thumb-1" src="assets/img/hero/hero-2/thumb.jpg" alt="">
                                    <img class="thumb-2 d-none d-sm-inline-block" src="assets/img/hero/hero-2/thumb-2.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="td-hero-2-bigtitle">
                                    <h2 class="td-split-text td-split-in-right">STARTUP</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- td-about-main-area-start -->
                <div class="td-about-main-area td-service-2-wrap pt-150 pb-125">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div class="td-service-2-title-wrap text-center mb-60 td-title-anim">
                                    <span class="td-section-2-subtitle mb-25 d-inline-block">//  Who we are</span>
                                    <h2 class="td-section-2-title">We provide brilliant ideas to help
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="td-service-main-expreance mb-30  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                ...
                                <div class="td-service-main-strategy-wrap ml-50">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="td-service-main-strategy mb-40  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="td-service-main-strategy mb-40  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                        ...
                                        <div class="col-12">
                                            <div class="td-service-main-strategy  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                ...
                <!-- td-about-main-area-end -->

                <!-- td-service-area-start -->
                <div class="td-service-area hover-section td-btn-trigger">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-9 col-md-9">
                                <div class="td-service-2-title-wrap mb-40  wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">
                                    ...
                                    <h2 class="td-section-2-title">Our full creative <br>startup <span>agency<br> service</span></h2>
                                </div>
                            </div>
                ...
                <div class="td-testimonial-area td-btn-trigger td-testimonial-2-wrap pt-155 pb-50">
                    <div class="container">
                        <div class="row align-items-center mb-20">
                            <div class="col-lg-9">
                                <div class="td-service-2-title-wrap mb-40">
                                    <span class="td-section-2-subtitle mb-25 d-block">//  Our clients feedback</span>
                                    <h2 class="td-section-2-title d-inline-block">What our client say <br> about <span>our parody</span></h2>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="td-testimonial-left mb-40  td-btn-bounce">
                        ...
                        <div class="row">
                            <div class="col-lg-2 order-md-2 order-lg-0 mb-40">
                                <div class="td-testimonial-navigation">
                                    ...
                                    <span class="td-testimonial-next ml-10 d-inline-block">
                                        <svg width="31" height="24" viewBox="0 0 31 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-lg-4 order-md-1 order-lg-1">
                                <div class="td-testimonial-thumb mb-40">
                                    <img class="w-100 td-rounded-10" src="assets/img/testimonial/tes-2/thumb.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 order-md-3">
                                <div class="td-testimonial-slide-content ml-30 mb-40">
                                    <div class="swiper-container td-testimonial-slider mb-120">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="td-testimonial-slide-content">
                                                    <span class="d-block mb-35">
                                                        <svg width="100" height="72" viewBox="0 0 100 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M21.4286 41.8731H1V0.99707H41.8571V42.6371L27.9531 70.457H8.76046L22.3231 43.3201L23.0463 41.8731H21.4286Z" stroke="#0A1119" stroke-opacity="0.3" stroke-width="2" />
                                                            <path d="M78.5711 41.8731H58.1426V0.99707H98.9997V42.6371L85.0957 70.457H65.903L79.4656 43.3201L80.1888 41.8731H78.5711Z" stroke="#0A1119" stroke-opacity="0.3" stroke-width="2" />
                                                        </svg>
                                                    </span>
                                                    <p class="mb-90">Some definitions of marketing highlight marketing's ability to produce
                                                        value to shareholders of the firm as well. In this context, marketing 
                                                        can be defined as "the management process that seeks to
                                                        maximise returns to shareholders</p>
                                                    <h6>David Backhum</h6>
                                                    <span>Designer</span>
                                                </div>
                                            </div>
                ...
                <!-- td-text-slider-2-area-start -->
                <div class="td-text-slider-2-area fix pb-140">
                    <div class="swiper-container td-text-2-home-slider">
                        <div class="swiper-wrapper slide-transtion">
                            <div class="swiper-slide">
                                <div class="td-text-home-2">
                                    <h2>STARTUP AGENCY</h2>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="td-text-home-2">
                                    <h2>GROWING BUSINEES</h2>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="td-text-home-2">
                                    <h2>STARTUP AGENCY  GROWING BUSINEES</h2>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="td-text-home-2">
                        ...
                        <div class="row gx-0">
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="td-counter-4-item p-relative">
                                    <h2 class="title mb-135"><span class="odometer" data-count="970">0</span>+</h2>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="position">01</h5>
                                        <span class="para">Projects<br> completed</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="td-counter-4-item p-relative">
                                    <h2 class="title mb-135"><span class="odometer" data-count="18">0</span>+</h2>
                                    <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="td-counter-4-item p-relative">
                                    <h2 class="title mb-135"><span class="odometer" data-count="120">0</span>K</h2>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="position">03</h5>
                                        <span class="para">Happy <br> customers</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="td-counter-4-item p-relative">
                                    <h2 class="title mb-135"><span class="odometer" data-count="25">0</span>+</h2>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="position">04</h5>
                                        <span class="para">Award <br> winning</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="td-feature-area fix">
                    <div class="fix">
                        <img data-speed=".9" class="w-100" src="assets/img/bigimage/thumb.jpg" alt="">
                    </div>
                ...
                <div class="td-faq-2-area pt-160">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="td-faq-2-thumb mb-30 wow fadeInLeft fix td-rounded-10" data-wow-delay=".5s" data-wow-duration="1s">
                                    <img data-speed=".9" class="td-rounded-10" src="assets/img/faq/faq-2/thumb.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="td-faq-4-wrap-right td-faq-2-wrap-right mb-30 wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="td-service-2-title-wrap">
                                        <span class="td-section-2-subtitle mb-25 d-block">//  Our faq’s</span>
                                        <h2 class="td-section-2-title d-inline-block">Frequently asked <span>questions</span></h2>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-7">
                                <div class="td-service-2-title-wrap mb-60 td-title-anim">
                                    <span class="td-section-2-subtitle mb-25 d-block">//  Parody working process</span>
                                    <h2 class="td-section-2-title d-inline-block">Our standard design thinking <span>process</span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row gx-0">
                ...
                <!-- td-team-area-start -->
                 <div class="td-team-area pt-160 pb-130 td-btn-trigger">
                    <div class="container">
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-7 col-md-7">
                                <div class="td-service-2-title-wrap mb-40 td-title-anim">
                                    <span class="td-section-2-subtitle mb-25 d-block">//  Our team members</span>
                                    <h2 class="td-section-2-title d-inline-block">Parody have creative team <span>members</span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="td-team-2-wrap pb-130 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="row align-items-center">
                                        <div class="col-lg-7 col-md-6 col-sm-6">
                                            <div class="td-team-2-thumb fix td-rounded-10 mb-30">
                                                <img class="td-rounded-10 w-100" src="assets/img/team/team-2/thumb.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-6 col-sm-6">
                                            <div class="td-team-2-content ml-35 mb-30">
                                                <span class="td-team-2-subtitle d-inline-block mb-5">Product designer</span>
                                                <h3 class="td-team-2-title mb-15"><a href="team-details.html">Nela Vaduri</a></h3>
                                                <div class="td-team-2-feature-list mb-20">
                                                    <ul>
                                                ...
                                                <div class="td-team-2-social">
                                                    ...
                                                    <a href="#">
                                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.28727 0.246582H0.400391L6.19454 7.86329L0.771044 14.2528H3.27686L7.37883 9.42021L11.0212 14.2084H15.9081L9.94559 6.37031L9.95615 6.38383L15.0899 0.335559H12.5841L8.77167 4.82709L5.28727 0.246582ZM3.09786 1.58051H4.61921L13.2106 12.8743H11.6893L3.09786 1.58051Z" fill="currentColor" />
                                                        </svg>
                                                    </a>
                                                    <a href="#">
                                                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <ellipse cx="8.40004" cy="8.24932" rx="6.99965" ry="7.00274" stroke="currentColor" stroke-width="1.5" />
                                                            <path d="M15.3987 9.13485C14.7499 9.01314 14.0827 8.94971 13.4018 8.94971C9.65534 8.94971 6.32316 10.8702 4.19922 13.8516" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                                                            <path d="M13.2998 3.34692C11.1093 5.91513 7.8176 7.54857 4.13699 7.54857C3.19536 7.54857 2.27918 7.44166 1.40039 7.23953" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                                                            <path d="M10.2324 15.2527C10.4078 14.4026 10.5 13.5222 10.5 12.6202C10.5 8.19722 8.28413 4.29094 4.90027 1.94751" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                                                        </svg>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="td-team-2-wrap wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="row align-items-center">
                                        <div class="col-lg-7 col-md-6 col-sm-6">
                                            <div class="td-team-2-thumb fix td-rounded-10 mb-30">
                                                <img class="td-rounded-10 w-100" src="assets/img/team/team-2/thumb-2.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-6 col-sm-6">
                                            <div class="td-team-2-content ml-35 mb-30">
                                                <span class="td-team-2-subtitle d-inline-block mb-5">Manager</span>
                                                <h3 class="td-team-2-title mb-15"><a href="team-details.html">Asha Voshle</a></h3>
                                                <div class="td-team-2-feature-list mb-20">
                                                    <ul>
                                                        <li>Team collaboration</li>
                                                        <li>Brand identity</li>
                                ...
                                <div class="td-team-2-btn">
                                    <div class="td-btn-group mt-70  td-btn-group-black">
                                        <a class="td-btn-circle" href="team.html">
                                            <i class="fa-solid fa-arrow-right"></i>
                                        </a>
                                        <a class="td-btn-2 td-btn-primary" href="team.html">Explore our team</a>
                                        <a class="td-btn-circle" href="team.html">
                                            <i class="fa-solid fa-arrow-right"></i>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="td-team-2-wrap  pb-130 pt-160 wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="row align-items-center">
                                        <div class="col-lg-7 col-md-6 col-sm-6">
                                            <div class="td-team-2-thumb fix td-rounded-10 mb-30">
                                                <img class="td-rounded-10 w-100" src="assets/img/team/team-2/thumb-2.jpg" alt="">
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-6">
                                            <div class="td-team-2-content ml-35 mb-30">
                                                <span class="td-team-2-subtitle d-inline-block mb-5">Designer</span>
                                                <h3 class="td-team-2-title mb-15"><a href="team-details.html">Jion Marcel</a></h3>
                                                <div class="td-team-2-feature-list mb-20">
                                                    <ul>
                                                        <li>Team collaboration</li>
                                                        <li>Brand identity</li>
                                ...
                                <div class="td-team-2-wrap wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="row align-items-center">
                                        <div class="col-lg-7 col-md-6 col-sm-6">
                                            <div class="td-team-2-thumb fix td-rounded-10 mb-30">
                                                <img class="td-rounded-10 w-100" src="assets/img/team/team-2/thumb-4.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-6 col-sm-6">
                                            <div class="td-team-2-content ml-35 mb-30">
                                                <span class="td-team-2-subtitle d-inline-block mb-5">Developer</span>
                                                <h3 class="td-team-2-title mb-15"><a href="team-details.html">Peal Steals</a></h3>
                                                <div class="td-team-2-feature-list mb-20">
                                                    <ul>
                                                        <li>Team collaboration</li>
                                                        <li>Brand identity</li>
                ...
                <!-- td-achievement-area-start -->
                <div class="td-achievement-area include-bg pt-155 pb-130" data-background="assets/img/achivment/bg.jpg">
                    <div class="container">
                        <div class="row justify-content-center mb-60">
                            <div class="col-xl-8 col-lg-10">
                                <div class="td-achievement-title-wrap text-center mb-60 td-title-anim">
                                    <span class="td-section-2-subtitle mb-30 d-block">//  Parody working process</span>
                                    <h2 class="td-section-2-title d-inline-block mb-30">Amazing interactive design
                                        and user experience for
                                        better <span>productivity</span></h2>
                                    <div class="td-btn-group justify-content-center  td-btn-group-yellow">
                                        <a class="td-btn-circle" href="contact.html">
                                            <i class="fa-solid fa-arrow-right"></i>
                                        </a>
                                        <a class="td-btn-2 td-btn-primary" href="contact.html">LET’S GET CONNECTED</a>
                                        <a class="td-btn-circle" href="contact.html">
                                            <i class="fa-solid fa-arrow-right"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 cil-sm-6 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="td-achievement-item text-center mb-30">
                                    <img class="mb-20" src="assets/img/achivment/icon.png" alt="">
                                    <p>100% Job Success on <br>Upwork</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 cil-sm-6 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="td-achievement-item text-center mb-30">
                                    <img class="mb-20" src="assets/img/achivment/icon-2.png" alt="">
                                    <p>5 Stars Rating on<br>  GoodFirms</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 cil-sm-6 wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="td-achievement-item text-center mb-30">
                                    <img class="mb-20" src="assets/img/achivment/icon-3.png" alt="">
                                    <p>Top 100 Global Companies<br> on Clutch</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 cil-sm-6 wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div class="td-achievement-item text-center mb-30">
                                    <img class="mb-20" src="assets/img/achivment/icon-4.png" alt="">
                                    <p>#1 Team in the world<br> on Dribbble</p>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- td-achievement-area-end -->

                <!-- td-blog-area-start -->
                <div class="td-blog-area pt-155">
                    <div class="container">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-5 mb-80">
                                <div class="td-blog-2-btn text-lg-end td-title-anim">
                                    <div class="td-btn-group  td-btn-group-black">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="td-blog-2-wrap mb-30">
                                    <div class="td-blog-2-avatar-wrap mb-25 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="td-blog-2-avatar-thumb mr-15">
                                                <img src="assets/img/blog/blog-2/avatar.png" alt="">
                                            </div>
                                            <div class="td-blog-2-avatar-content">
                                                <h6 class="mb-0">David Marlon</h6>
                                                <span>Designer</span>
                                            </div>
                                        </div>
                                        <div class="td-blog-2-avatar-date">
                                            <span>August 12, 2024</span>
                                        </div>
                                    </div>
                                    <div class="td-blog-2-thumb td-rounded-10 fix mb-25">
                                        <img class="w-100 td-rounded-10" src="assets/img/blog/blog-2/blog.jpg" alt="">
                                    </div>
                                    <h3 class="td-blog-2-title"><a href="blog-details.html">Our mission is to revolutionize of
                                        creative work for companies</a></h3>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="td-blog-2-wrap mb-30">
                                    <div class="td-blog-2-avatar-wrap mb-25 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="td-blog-2-avatar-thumb mr-15">
                                                <img src="assets/img/blog/blog-2/avatar-2.png" alt="">
                                            </div>
                                            <div class="td-blog-2-avatar-content">
                                                <h6 class="mb-0">Huaka Brain</h6>
                                                <span>Designer</span>
                                            </div>
                                        </div>
                                        <div class="td-blog-2-avatar-date">
                                    ...
                                    <div class="td-blog-2-thumb td-rounded-10 fix mb-25">
                                        <img class="w-100 td-rounded-10" src="assets/img/blog/blog-2/blog-2.jpg" alt="">
                                    </div>
                                    <h3 class="td-blog-2-title"><a href="blog-details.html">Our brand strategy services focus
                                        on creating a cohesive</a></h3>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="td-blog-2-wrap mb-30">
                                    <div class="td-blog-2-avatar-wrap mb-25 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="td-blog-2-avatar-thumb mr-15">
                                                <img src="assets/img/blog/blog-2/avatar-3.png" alt="">
                                            </div>
                                            <div class="td-blog-2-avatar-content">
                                                <h6 class="mb-0">Navana Juisa</h6>
                                                <span>Designer</span>
                                            </div>
                                        </div>
                                        <div class="td-blog-2-avatar-date">
                                    ...
                                    <div class="td-blog-2-thumb td-rounded-10 fix mb-25">
                                        <img class="w-100 td-rounded-10" src="assets/img/blog/blog-2/blog-3.jpg" alt="">
                                    </div>
                                    <h3 class="td-blog-2-title"><a href="blog-details.html">Our mission is to revolutionize of
                                        creative work for companies</a></h3>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-30">
                                <div class="td-footer-3-widget">
                                    <h2 class="td-footer-2-bigtitle">Entrust design<br> to professionals</h2>
                                </div>
                            </div>
