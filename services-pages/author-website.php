                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="td-about-main-thumb mb-40 fix td-rounded-10 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">
                                    <img data-speed=".9" class="w-100 td-rounded-10" src="<?= $BASE_URL ?>assets/img/about/main/aurth-web.jpg" alt="Custom author website design on desktop and mobile screens">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-4">
                                <div class="td-about-left mb-30">
                                    ...
                                    <div class="td-about-left-thumb ml-60 fix td-rounded-10">
                                        <img data-speed=".9" src="<?= $BASE_URL ?>assets/img/about/main/aurth-abt.jpg" alt="Author website build process with our design team" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="td-about-content mb-30">
                                    ...
                                    <div class="td-about-thumb-wrap d-flex align-items-center justify-content-end">
                                        ...
                                        <div class="td-about-thumb fix td-rounded-10">
                                            <img data-speed=".9" src="<?= $BASE_URL ?>assets/img/about/main/aurth-abt-2.jpg" alt="Finished author website showcasing books and reader engagement" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gx-0">
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="td-service-process-item mt-120">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <!-- SVGs unchanged -->
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/custweb.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="td-service-process-item">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/branding.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="td-service-process-item mt-120">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/ecom.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div class="td-service-process-item">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/blogint.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="td-service-process-item mt-120">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <!-- SVGs unchanged -->
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/port.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="td-service-process-item">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/seo.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="td-service-process-item mt-120">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/responsive.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div class="td-service-process-item">
                                    <span class="icons mb-60 d-flex align-items-start justify-content-between">
                                        <img src="<?= $BASE_URL ?>assets\img\service\servicesico/cms.png" alt="Custom Website Design" width="64" height="64" loading="lazy">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="td-faq-2-thumb mb-30 fix td-rounded-10">
                                    <img data-speed=".9" class="td-rounded-10" src="<?= $BASE_URL ?>assets/img/about/main/aurth-faq.jpg" alt="Author reviewing their newly built website" loading="lazy">
                                </div>
                            </div>
                            <div class="col-lg-6">
