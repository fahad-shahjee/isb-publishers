...
<head>
    ...
    <meta name="twitter:description" content="ISB Ghostwriters offers expert proofreading services, correcting grammar, spelling, punctuation, and formatting for Amazon KDP, print, or eBook publishing.">
                            ...
                            <div class="col-lg-4">
                                <div class="td-about-left mb-30">
                                    ...
                                    <div class="td-about-left-thumb ml-60 fix td-rounded-10">
                                        <img data-speed=".9" src="<?= $BASE_URL ?>assets/img/about/main/be-abt.png" alt="Manuscript page being proofread for grammar and clarity" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
