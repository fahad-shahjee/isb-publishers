...
<head>
    ...
    <meta name="twitter:description" content="From First Draft to Global Bookshelf">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="td-hero-3-title-wrap">
                                    <h1 class="td-hero-3-title text-center td-split-text td-split-in-right" style="color:white;">
